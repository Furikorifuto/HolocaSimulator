...
public class CardBattleForm extends JFrame{
    public static String count = "start";
    public static int nextTime = 100;
    public static boolean reDrawFlag = false;
    public static boolean timerStopFlag = false;
    public static boolean preceding1pFlag;
    public static BaseDeck baseDeck1P;
    public static BaseDeck baseDeck2P;
    public static Timer timer;
    //stage
    public static LeaderCard leader1P;
    public static LeaderCard leader2P;
    public static List<BaseCard> hand1p = new ArrayList<>();
    public static List<BaseCard> hand2p = new ArrayList<>();
    ...
    public static JLabel labelYellDeckValue1P = new JLabel();
    public JLabel labelMainDeck1P = new JLabel("Deck");
    public static JLabel labelMainDeckValue1P = new JLabel();
    public JLabel labelHand1P = new JLabel("Hand");
    public static JLabel labelHandValue1P = new JLabel();
    ...
    public static JLabel labelLeaderValue1P = new JLabel();
    ...
    public static JLabel labelYellDeckValue2P = new JLabel();
    public JLabel labelMainDeck2P = new JLabel("Deck");
    public static JLabel labelMainDeckValue2P = new JLabel();
    public JLabel labelHand2P = new JLabel("Hand");
    public static JLabel labelHandValue2P = new JLabel();
    ...
    public static JLabel labelLeaderValue2P = new JLabel();
    ...
    public static DefaultListModel<BaseCard> listModel1 = new DefaultListModel<>();
    public JList<BaseCard> listHand1 = new JList<>(listModel1);
    public JScrollPane scrollPane1PHand = new JScrollPane(listHand1);

    public static DefaultListModel<BaseCard> listModel2 = new DefaultListModel<>();
    ...
    public CardBattleForm() {
        ...
        listHand1.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                CardBattleForm.textAreaLog.append(listHand1.getSelectedValue().toString()+"\n");
            }
        });
        ...
        timer = new Timer(nextTime, new MainGameWithTimer());
        timer.start();
    }
}
